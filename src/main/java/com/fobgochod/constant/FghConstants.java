...
public class FghConstants {
    ...
    public static final String HTTP_HEADER_USER_TOKEN = "digi-middleware-auth-user";
    public static final String HTTP_HEADER_USER_INFO = "digi-middleware-auth-user-info";
